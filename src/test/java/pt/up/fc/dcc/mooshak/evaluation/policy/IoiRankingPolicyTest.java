...
public class IoiRankingPolicyTest {
	...
	Problem problem;
	IoiRankingPolicy rankingPolicy;
	EventSender sender;
	...
	public void setUp() throws Exception {
		...
		rankingPolicy = new IoiRankingPolicy(contest);
	...
	public void test2WrongAnswer1Accepted() throws Exception {
		...
		assertEquals("100 (3)",rankingEvent.getRecord().get("J"));
		assertEquals("100",rankingEvent.getRecord().get("points"));
	...
	public void testChangeWAToAcceptedSubmission() throws Exception {
		...
		assertEquals("100 (7)",rankingEvent.getRecord().get("J"));
		assertEquals("100",rankingEvent.getRecord().get("points"));
