...
public class IncreasingVariablePermutations<T extends HasInteger & Comparable<T>> implements Iterable<List<T>> {
	...
	IncreasingVariablePermutations(List<T> values) {
		this.values = values;
