...
/**
 * TextBox accepting only digits
 */
public class IntegerBox extends Composite implements MooshakWidget {
	...
	interface CustomTextBoxUiBinder extends UiBinder<Widget, IntegerBox> {
	}
