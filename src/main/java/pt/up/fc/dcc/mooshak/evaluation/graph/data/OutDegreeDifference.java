...
public class OutDegreeDifference implements GraphDifference {
	Node node;
	Set<DifferentConnection> differences;

	public OutDegreeDifference(Node node, Set<DifferentConnection> differences) {
		this.node = node;
	...
	public String toString() {
		return "OutDegreeDifference [node=" + node.getId() + ", differences="
				+ differences + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OutDegreeDifference other = (OutDegreeDifference) obj;
		if (differences == null) {
