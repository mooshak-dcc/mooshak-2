...
public class AskViewImpl extends ListingImpl implements AskView, ResizeHandler, RequiresResize {
	...
	public AskViewImpl(int rows) {
		...
		container.addResizeHandler(new ResizeHandler() {
			...
			public void onResize(ResizeEvent event) {
				listingContainer.setHeight((event.getHeight() - formContainer.getOffsetHeight()) 
						+ "px");
				grid.setHeight(Math.max((event.getHeight() - formContainer.getOffsetHeight() - 65), 0) + "px");
	...
	public void setDraggableParentProperties() {
		question.addDomHandler(new MouseMoveHandler() {
		...
		question.addDomHandler(new MouseDownHandler() {
		...
		answer.addDomHandler(new MouseMoveHandler() {
		...
		answer.addDomHandler(new MouseDownHandler() {
	...
	public void setMessage(String message, boolean result) {
		if(result)
			this.message.getElement().getStyle().setColor("green");
		else 
	...
	public void setFiltering() {
		...
		dataProvider.addFilter("problemId", Arrays.asList(problemId, 
