...
import pt.up.fc.dcc.mooshak.client.gadgets.programtestcases.ProgramTestCasesViewImpl;
...
/**
 * Gadget for testing programs
 * 
 * @author josepaiva
 */
public class ProgramTestCases extends Gadget implements HasLearningTime {
	...
	public ProgramTestCases(ParticipantCommandServiceAsync rpcService, EnkiCommandServiceAsync rpcEnki,
		...
		ProgramTestCasesView view = new ProgramTestCasesViewImpl();

		ProgramTestCasesPresenter presenter = new ProgramTestCasesPresenter(this.eventBus, this.rpc, this.rpcEnki, view,
				token);
		presenter.go(null);
